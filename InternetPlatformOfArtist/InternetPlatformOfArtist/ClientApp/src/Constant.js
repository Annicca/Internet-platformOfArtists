...
export const detailGroup = ['Пользователь', 'Телефон', 'Почта', 'Название', 'Город', 'Адрес'];
export const detailCompetition = ['Пользователь', 'Телефон', 'Почта', 'Название', 'Город', 'Дата начала', 'Дата окончания'];